...
define m = Character ("Mugger", color = "#303030", image = "mugger")
...
define k = Character("Konrad", color = "#067d26" , image = "konrad")
define t = Character("Taizhou", color = "#14234d" , image = "taizhou")
define j = Character("Johnny", color = "#330808", image = "johnny")
